...
const TeamMembers = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col bg-gradient-to-b from-slate-50 via-white to-slate-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900">
        <Navbar />
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-slate-50 via-white to-slate-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900">
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-900 dark:text-gray-100 sm:text-3xl">
                Team Members
              </h1>
        ...
        <div className="mb-6 space-y-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 rounded-xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:text-gray-200 transition-all"
            />
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-slate-50 dark:hover:bg-gray-700 transition-colors"
            >
            ...
            {showFilters && (
              <div className="flex flex-wrap items-center gap-3 animate-in fade-in slide-in-from-top-2">
                <select
                  ...
                  className="px-4 py-2 rounded-lg border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-gray-200"
                >
        ...
        {filteredMembers.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 text-center">
            <Users className="h-16 w-16 text-slate-300 dark:text-gray-600 mb-4" />
          ...
          <div className="space-y-3">
            {filteredMembers.map((member) => (
              <div
                ...
                className="group relative flex items-center gap-4 p-4 rounded-xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-slate-300 dark:hover:border-gray-600 hover:shadow-md transition-all cursor-pointer"
              >
                {/* Avatar */}
                ...
                {/* Join Date */}
                <div className="hidden sm:flex items-center gap-1.5 text-sm text-slate-500 dark:text-gray-400">
      ...
      {selectedMember && (
        ...
        >
          <div
            className="relative w-full max-w-md rounded-2xl bg-white dark:bg-gray-800 shadow-xl animate-in zoom-in-95 slide-in-from-bottom-4"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Close Button */}
            <button
              onClick={() => setSelectedMember(null)}
              className="absolute right-4 top-4 p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-gray-700 transition-colors"
            >
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col items-center mb-6">
                ...
                <p className="text-sm text-slate-500 dark:text-gray-400">{selectedMember.email}</p>
              </div>

              {/* Details */}
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-gray-700">
                  <div className="flex items-center gap-3">
                    <Shield className="h-5 w-5 text-slate-500 dark:text-gray-400" />
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-gray-700">
                  <div className="flex items-center gap-3">
                    <Clock className="h-5 w-5 text-slate-500 dark:text-gray-400" />
                    <span className="text-sm font-medium text-slate-700 dark:text-gray-300">
                      Joined
                    </span>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-gray-700">
                  <div className="flex items-center gap-3">
                    <CheckCircle className="h-5 w-5 text-slate-500 dark:text-gray-400" />
                    <span className="text-sm font-medium text-slate-700 dark:text-gray-300">
                      Status
                    </span>
                  </div>
              ...
              <div className="mt-6 pt-4 border-t border-slate-200 dark:border-gray-700">
                <button
                  onClick={() => setSelectedMember(null)}
                  className="w-full px-4 py-2.5 rounded-xl bg-slate-100 dark:bg-gray-700 text-slate-700 dark:text-gray-300 font-semibold hover:bg-slate-200 dark:hover:bg-gray-600 transition-colors"
                >
                  Close
                </button>
              </div>
